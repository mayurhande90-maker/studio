...
const featureCategories = [
  ...
  },
  {
    ...
    description: 'Turn imagination into reality with these creative AI experiences.',
    features: [
      {
        icon: Youtube,
    ...
    <section id="features" className="w-full py-20 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
          <Badge variant="outline" className="text-sm font-medium bg-primary/10 text-primary border-primary/20 py-1 px-3">
            Features
          </Badge>
