...
export function Hero() {
  return (
    <section id="home" className="w-full relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-background via-secondary/50 to-background animated-gradient -z-10" />
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center">
          <div className="space-y-4 max-w-4xl mx-auto">
            <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none">
              Transform Your Photos with the Magic of{' '}
              <span className="text-gradient">AI</span>
            </h1>
            <p className="max-w-2xl mx-auto text-muted-foreground md:text-xl">
              Remove backgrounds, enhance lighting, colorize memories, and
              create marketing-ready photos — all in seconds.
            </p>
          </div>
